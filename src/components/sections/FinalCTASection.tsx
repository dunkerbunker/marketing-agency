...
export default function FinalCTASection() {
  return (
    <section id="contact" className="py-32 md:py-48 bg-[#0b0e14] text-offwhite relative overflow-hidden flex items-center justify-center min-h-[80vh]">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none opacity-60">
        ...
        <div className="absolute w-[450px] h-[450px] md:w-[650px] md:h-[650px] rounded-full border border-[#00E5FF]/30"></div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 px-6">
        ...
        >
          <h2 className="text-[4rem] sm:text-7xl md:text-[8rem] lg:text-[10rem] font-display font-black uppercase tracking-tighter leading-[0.85] mb-8 text-offwhite z-10 relative">
            Your Brand <br/>
            Shouldn't <br/>
            <span className="text-transparent" style={{ WebkitTextStroke: '2px #00E5FF' }}>Blend</span> <span className="text-sunset">In.</span>
          </h2>
